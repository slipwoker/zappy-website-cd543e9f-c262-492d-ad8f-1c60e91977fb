document.addEventListener('DOMContentLoaded', function () {
  ...
  if (animatableElements.length > 0) {
    ...
    animatableElements.forEach(function (el) {
      const animationType = el.dataset.animate || getAnimationType(el);
      const styles = defaultStyles[animationType] || defaultStyles['fade-in'];
    ...
    function getAnimationType(el) {
      const classes = ['fade-in-up', 'fade-in-down', 'fade-in-left', 'fade-in-right', 'fade-in'];
    ...
    function revealOnScroll() {
      ...
      animatableElements.forEach(function (el) {
        ...
        const isVisible = rect.top < windowHeight - revealOffset && rect.bottom > 0;
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "Vilon Glass - וילון גלאס משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'cd543e9f-c262-492d-ad8f-1c60e91977fb',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'cd543e9f-c262-492d-ad8f-1c60e91977fb';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'cd543e9f-c262-492d-ad8f-1c60e91977fb';
